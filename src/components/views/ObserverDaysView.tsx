    ...
    <div className="flex min-h-0 flex-1 flex-col gap-2.5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 rounded-xl border border-[#dededb] bg-white p-2.5 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-xs font-black text-[#171717]">أيام التفرغ والحضور للمراقبين (تعديل مباشر)</h2>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-7 w-56 rounded-lg border border-[#cfcfcb] pr-7 pl-2 text-xs font-semibold outline-none focus:border-[#1f4d78]"
          />
        </div>
      </div>
          ...
          <table className="w-full border-separate border-spacing-0 text-center text-xs">
            <thead className="sticky top-0 z-10 bg-[#eef3f8]">
              <tr className="text-[10px] font-black text-[#171717]">
                ...
                <th className="border-b border-l border-[#cfcfcb] px-2 py-1.5 min-w-24">التخصص</th>
                <th className="border-b border-[#cfcfcb] px-3 py-1.5">أيام الحضور الأسبوعية (انقر للتبديل)</th>
              </tr>
            </thead>
              ...
              {filtered.map((obs, idx) => {
                ...
                return (
                  <tr key={obs.id} className="hover:bg-[#fbfbfa] transition">
                    ...
                    <td className="border-b border-[#ecece9] px-3 py-1">
